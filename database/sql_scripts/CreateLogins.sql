...
CREATE LOGIN pko_trade WITH PASSWORD = 'Y87dc#$98', DEFAULT_DATABASE = TradeDB;
USE [AccountServer];
...
USE [TradeDB];
CREATE USER pko_trade FROM LOGIN pko_trade;
ALTER ROLE db_owner ADD MEMBER pko_trade;