...
UIRender::UIRender()
: _nGuiWidth(1024), _nGuiHeight(768), _fScreenScaleX(1.0), _fScreenScaleY(1.0)
...
void UIRender::RenderTextureRect(int nX, int nY, LETexRect *pRect, DWORD dwColor)
{
	LPTEXTURE pTexture = GetTextureByID(pRect->nTextureNo);
	if(!pTexture) return;
...
// class CGuiPic
//---------------------------------------------------------------------------
bool CGuiPic::LoadImage( LETexRect* pTex, const char* file, int w, int h, int tx, int ty, float scale_x, float scale_y )
{
