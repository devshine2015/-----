...
extern void	CP_Frnd_Del_Group(const char * groupname);
extern void	CP_Frnd_Add_Group(const char * groupname);
extern void	CP_Frnd_Move_Group(unsigned long chaid, const char * oldgroup,const char * newgroup);
// End
...
//	BYTE reason;
//}S_MEMBERINFO;
extern void NetSay2You(stNetSay2You &say2you);
extern void	NetSay2Team(unsigned long chaid,const char *word);
extern void NetSay2Gud(const char* src, const char* word);
extern void NetSay2All(stNetSay2All &say2all);
extern void NetSay2Trade(stNetSay2All &say2all);
...
extern void NetFrndStart(stNetFrndStart &self,stNetFrndStart arrCha[],unsigned short arrnum,string groupNames[],unsigned short groupNum);
extern void	NetFrndDelGroup(const char * delgroup);
extern void	NetFrndAddGroup(const char * addgroup);
extern void	NetFrndMoveGroup(unsigned long cha_id,const char *oldgroup,const char * newgroup);
extern void	NetFrndChangeGroup(const char *oldgroup,const char * newgroup);
//End

// Add by lark.li 20080808 begin
extern void NetFrndRefreshInfo(unsigned long cha_id, stPersonInfo* pInfo, const char * motto,unsigned short icon,unsigned short degree,const char * job,const char *guildname);
// End
...
// Add by lark.li 20080808 begin
extern void	NetQueryPersonInfo(stQueryResoultPersonInfo* pInfo, int num);
// End
...
// Addby lark.li 20080805 begin
extern BOOL	PC_FRND_DEL_GROUP(LPRPACKET pk);
extern BOOL	PC_FRND_ADD_GROUP(LPRPACKET pk);
extern BOOL	PC_FRND_MOVE_GROUP(LPRPACKET pk);
// End
extern BOOL	PC_FRND_CHANGE_GROUP(LPRPACKET pk);
extern BOOL	PC_FRND_REFRESH_INFO(LPRPACKET pk);

extern BOOL	PC_CHANGE_PERSONINFO(LPRPACKET pk);

// Add by lark.li 20080808 begin
extern BOOL	PC_QUERY_PERSONINFO(LPRPACKET pk);
// End
