...
// Begin
inline void SetPreNameByEnergy(int nItem, short *itemEnergy, char szName[16],
                               DWORD &dwColor, int len = 0, short sex = 0) {
  if (!nItem) {
    szName[0] = '\0';
    return;
  }
  ...
  RetPreName *pRet = (RetPreName *)CLU_CallScriptFunction(
      "GetPreviouName", "char*,char*", "ushort,ushort,ushort", itemEnergy[0],
      itemEnergy[1], sex); //最后参数0为正常性别,1为特殊性别
  if (pRet) {
    ...
    if (_r.length() <= 0 || _g.length() <= 0 || _b.length() <= 0) {
      ...
      dwColor = D3DCOLOR_ARGB(255, atoi(_r.c_str()), atoi(_g.c_str()),
                              atoi(_b.c_str()));
      return;
    }
  }
...
inline void SetPreName(int nItem, char szName[20], DWORD &dwColor,
                       int len = 0) {
  DWORD COLOR_SKYBLUE = D3DCOLOR_ARGB(255, 168, 168, 255);

  switch (nItem) {
    // case 3936:	strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_7) );   dwColor =
    // D3DCOLOR_ARGB(255,192,192,192); return; case 3937:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_8) );   dwColor =
    // D3DCOLOR_ARGB(255,000,255,012); return; case 3938:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_9) );   dwColor =
    // D3DCOLOR_ARGB(255,217,255,119); return; case 3939:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_10) );  dwColor =
    // D3DCOLOR_ARGB(255,070,182,240); return; case 3940:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_11) );  dwColor =
    // D3DCOLOR_ARGB(255,255,207,000); return; case 3941:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_12) );  dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return; case 3942:	strcpy( szName,
    // RES_STRING(CL_LANGUAGE_MATCH_13) );  dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return;
    ////Modify by sunny.sun 20080516(许立国要求该的新的Iteminfo)
    ////Begin
    // case 5816:  strcpy( szName, RES_STRING(CL_CHARACTER_CPP_00001) );
    // dwColor = D3DCOLOR_ARGB(255,192,192,192); return; case 5817: strcpy(
    // szName, RES_STRING(CL_CHARACTER_CPP_00002) );   dwColor =
    // D3DCOLOR_ARGB(255,000,255,012); return; case 5818:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00003) );		dwColor =
    // D3DCOLOR_ARGB(255,217,255,119); return; case 5819:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00004) );   dwColor =
    // D3DCOLOR_ARGB(255,070,182,240); return; case 5820:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00005) );   dwColor =
    // D3DCOLOR_ARGB(255,255,207,000); return; case 5821:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00006) );   dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return; case 5822:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00007) );   dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return; case 5823:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00008) );   dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return; case 5824:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_00009) ); dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return;
    ////Add by sunny.sun20080820 and swapChinese characters to English word by
    ///alfred.shi 20081030
    // case 6226:	strcpy( szName, RES_STRING(CL_CHARACTER_CPP_000010) );dwColor
    // = D3DCOLOR_ARGB(255,255,000,000); return;
    ////End

    // case 5331:	strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_922) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,192,192,192); return; case 5332:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_923) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,135,135,135); return; case 5333:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_924) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,255,255,255); return; case 5334:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_925) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,070,182,240); return; case 5335:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_926) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,000,255,012); return; case 5336:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_927) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,217,255,119); return; case 5337:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_928) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,255,207,000); return; case 5338:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_929) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,255,127,000); return; case 5339:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_930) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,255,000,000); return; case 5340:
    // strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_931) ); dwColor =
    // COLOR_SKYBLUE; return;//D3DCOLOR_ARGB(255,241,014,240); return;
    ////Add by sunny.sun 20080904
    // case 6388:	strcpy( szName, RES_STRING(CL_CHARACTER_CPP_000011) );
    // dwColor = D3DCOLOR_ARGB(255,000,255,012); return; case 6386: strcpy(
    // szName, RES_STRING(CL_CHARACTER_CPP_000012));   dwColor =
    // D3DCOLOR_ARGB(255,217,255,119); return; case 6389:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000013) );  dwColor =
    // D3DCOLOR_ARGB(255,070,182,240); return; case 6387:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000014) );  dwColor =
    // D3DCOLOR_ARGB(255,255,207,000); return; case 6390:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000015) );  dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return; case 6391:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000016) );  dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return;

    // case 6434:	strcpy( szName, RES_STRING(CL_CHARACTER_CPP_000012) );
    // dwColor = D3DCOLOR_ARGB(255,217,255,119); return; case 6428: strcpy(
    // szName, RES_STRING(CL_CHARACTER_CPP_000013) );	 dwColor =
    // D3DCOLOR_ARGB(255,255,207,000); return; case 6429:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000017) );	 dwColor =
    // D3DCOLOR_ARGB(255,000,255,012); return; case 6430:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000018) );	 dwColor =
    // D3DCOLOR_ARGB(255,070,182,240); return; case 6431:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000019) );	 dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return; case 6432:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000020) );  dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return;

    ////	Add by alfred.shi 20081118	begin
    // case 6480:	strcpy( szName, RES_STRING(CL_CHARACTER_CPP_000021) );
    // dwColor = D3DCOLOR_ARGB(255,82,225,232); return; case 6484:	strcpy(
    // szName, RES_STRING(CL_CHARACTER_CPP_000022));   dwColor =
    // D3DCOLOR_ARGB(255,82,225,232); return; case 6488:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000023) );  dwColor =
    // D3DCOLOR_ARGB(255,82,225,232); return; case 6492:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000024) );  dwColor =
    // D3DCOLOR_ARGB(255,82,225,232); return; case 6481:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000025) );  dwColor = D3DCOLOR_ARGB(255,38,
    // 217, 226); return; case 6485:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000026) );  dwColor = D3DCOLOR_ARGB(255,38,
    // 217, 226); return; case 6489:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000027) );  dwColor = D3DCOLOR_ARGB(255,38,
    // 217, 226); return; case 6493:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000028) );	 dwColor = D3DCOLOR_ARGB(255,38,
    // 217, 226); return; case 6482:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000029) );	 dwColor = D3DCOLOR_ARGB(255,24,
    // 173, 180); return; case 6486:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000030) );	 dwColor = D3DCOLOR_ARGB(255,24,
    // 173, 180); return; case 6490:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000031) );	 dwColor = D3DCOLOR_ARGB(255,24,
    // 173, 180); return; case 6494:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000032) );	 dwColor = D3DCOLOR_ARGB(255,24,
    // 173, 180); return; case 6483:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000033) );  dwColor = D3DCOLOR_ARGB(255,0,
    // 102, 255); return; case 6487:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000034) );   dwColor = D3DCOLOR_ARGB(255,0,
    // 102, 255); return; case 6491:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000035));   dwColor = D3DCOLOR_ARGB(255,0,
    // 102, 255); return; case 6495:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000036) );  dwColor = D3DCOLOR_ARGB(255,0,
    // 102, 255); return; case 6496:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000037) );  dwColor =
    // D3DCOLOR_ARGB(255,255,0,0); return; case 6497:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000038) );  dwColor =
    // D3DCOLOR_ARGB(255,245,31,235); return; case 6498:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000039) );  dwColor =
    // D3DCOLOR_ARGB(255,77,77,77); return; case 6568:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000040) );	 dwColor =
    // D3DCOLOR_ARGB(255,103,204,255); return; case 6569:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000041) );	 dwColor =
    // D3DCOLOR_ARGB(255,255,0,255); return; case 6570:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000042) );	 dwColor =
    // D3DCOLOR_ARGB(255,23,55,93); return; case 6571:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000043) );	 dwColor =
    // D3DCOLOR_ARGB(255,103,204,255); return; case 6572:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000044) );	 dwColor =
    // D3DCOLOR_ARGB(255,255,0,255); return; case 6573:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000045) );  dwColor =
    // D3DCOLOR_ARGB(255,23,55,93); return; case 6574:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000046) );  dwColor =
    // D3DCOLOR_ARGB(255,103,204,255); return; case 6575:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000047) );   dwColor =
    // D3DCOLOR_ARGB(255,23,55,93); return; case 6576:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000048));   dwColor =
    // D3DCOLOR_ARGB(255,103,204,255); return; case 6577:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000049) );  dwColor =
    // D3DCOLOR_ARGB(255,103,204,255); return; case 6578:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000050) );  dwColor =
    // D3DCOLOR_ARGB(255,255,0,255); return; case 6579:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000051) );  dwColor =
    // D3DCOLOR_ARGB(255,23,55,93); return; case 6611:	strcpy( szName,
    // RES_STRING(CL_CHARACTER_CPP_000052) );  dwColor =
    // D3DCOLOR_ARGB(255,255,0,0); return; 	End.

    //// TOM版本
    // case 822:	strcpy( szName, RES_STRING(CL_LANGUAGE_MATCH_14) );  dwColor =
    // D3DCOLOR_ARGB(255,255,000,000); return;	// 荣誉勋章 case 823:	strcpy(
    // szName, RES_STRING(CL_LANGUAGE_MATCH_15) );  dwColor =
    // D3DCOLOR_ARGB(255,241,014,240); return;	// 财富勋章

  case 3936:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_7), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 192, 192, 192);
    return;
  case 3937:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_8), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 000, 255, 012);
    return;
  case 3938:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_9), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 217, 255, 119);
    return;
  case 3939:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_10), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 070, 182, 240);
    return;
  case 3940:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_11), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 207, 000);
    return;
  case 3941:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_12), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
  case 3942:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_13), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return;
    // Modify by sunny.sun 20080516(许立国要求该的新的Iteminfo)
    // Begin
  case 5816:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00001), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 192, 192, 192);
    return;
  case 5817:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00002), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 000, 255, 012);
    return;
  case 5818:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00003), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 217, 255, 119);
    return;
  case 5819:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00004), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 070, 182, 240);
    return;
  case 5820:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00005), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 207, 000);
    return;
  case 5821:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00006), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
  case 5822:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00007), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return;
  case 5823:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00008), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return;
  case 5824:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_00009), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
    // Add by sunny.sun20080820 and swapChinese characters to English word by
    // alfred.shi 20081030
  case 6226:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000010), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
    // End

  case 5331:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_922), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,192,192,192); return;
  case 5332:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_923), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,135,135,135); return;
  case 5333:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_924), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,255,255,255); return;
  case 5334:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_925), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,070,182,240); return;
  case 5335:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_926), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,000,255,012); return;
  case 5336:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_927), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,217,255,119); return;
  case 5337:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_928), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,255,207,000); return;
  case 5338:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_929), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,255,127,000); return;
  case 5339:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_930), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,255,000,000); return;
  case 5340:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_931), _TRUNCATE);
    dwColor = COLOR_SKYBLUE;
    return; // D3DCOLOR_ARGB(255,241,014,240); return;
    // Add by sunny.sun 20080904
  case 6388:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000011), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 000, 255, 012);
    return;
  case 6386:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000012), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 217, 255, 119);
    return;
  case 6389:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000013), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 070, 182, 240);
    return;
  case 6387:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000014), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 207, 000);
    return;
  case 6390:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000015), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
  case 6391:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000016), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return;
  ...
  case 6428:
    ...
    return;
  case 6429:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000017), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 000, 255, 012);
    return;
  case 6430:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000018), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 070, 182, 240);
    return;
  case 6431:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000019), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return;
  case 6432:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000020), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return;

    //	Add by alfred.shi 20081118	begin
  case 6480:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000021), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 82, 225, 232);
    return;
  case 6484:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000022), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 82, 225, 232);
    return;
  case 6488:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000023), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 82, 225, 232);
    return;
  case 6492:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000024), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 82, 225, 232);
    return;
  case 6481:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000025), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 38, 217, 226);
    return;
  case 6485:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000026), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 38, 217, 226);
    return;
  case 6489:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000027), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 38, 217, 226);
    return;
  case 6493:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000028), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 38, 217, 226);
    return;
  case 6482:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000029), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 24, 173, 180);
    return;
  case 6486:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000030), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 24, 173, 180);
    return;
  case 6490:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000031), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 24, 173, 180);
    return;
  case 6494:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000032), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 24, 173, 180);
    return;
  case 6483:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000033), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 102, 255);
    return;
  case 6487:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000034), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 102, 255);
    return;
  case 6491:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000035), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 102, 255);
    return;
  case 6495:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000036), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 102, 255);
    return;
  case 6496:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000037), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 0, 0);
    return;
  case 6497:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000038), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 245, 31, 235);
    return;
  case 6498:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000039), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 77, 77, 77);
    return;
    //	End.

  case 6568:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000040), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 103, 204, 255);
    return;
  case 6569:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000041), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 0, 255);
    return;
  case 6570:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000042), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 23, 55, 93);
    return;
  case 6571:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000043), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 103, 204, 255);
    return;
  case 6572:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000044), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 0, 255);
    return;
  case 6573:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000045), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 23, 55, 93);
    return;
  case 6574:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000046), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 103, 204, 255);
    return;
  case 6575:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000047), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 23, 55, 93);
    return;
  case 6576:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000048), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 103, 204, 255);
    return;
  case 6577:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000049), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 103, 204, 255);
    return;
  case 6578:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000050), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 0, 255);
    return;
  case 6579:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000051), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 23, 55, 93);
    return;
  case 6611:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000052), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 0, 0);
    return;
  case 6713:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000057), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 51, 51, 255);
    return;
  case 6714:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000058), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 153, 51);
    return;
  case 6715:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000060), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 225, 220, 200);
    return;
  case 6716:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000059), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 204, 0);
    return;
    // TOM版本
  case 822:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_14), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 000, 000);
    return; // 荣誉勋章
  case 823:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_15), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 241, 014, 240);
    return; // 财富勋章
  case 6949:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1021), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 207, 000);
    return;
  case 6950:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1021), _TRUNCATE);
  ...
  case 6952:
    ...
    return;
  case 6953:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1022), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6954:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1023), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6955:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1024), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6956:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1025), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6957:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1026), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6958:
    strncpy_s(szName, len, RES_STRING(CL_LANGUAGE_MATCH_1027), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 51, 204);
    return;
  default:
    szName[0] = '\0';
  }
...
inline void SetPreNameSex(int nItem, char szName[16], DWORD &dwColor,
                          int len = 0) {
  DWORD COLOR_SKYBLUE = D3DCOLOR_ARGB(255, 168, 168, 255);
  switch (nItem) {
  case 6707:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000053), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6717:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000054), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 51, 204);
    return;
  case 6708:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000055), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 0, 153, 255);
    return;
  case 6718:
    strncpy_s(szName, len, RES_STRING(CL_CHARACTER_CPP_000056), _TRUNCATE);
    dwColor = D3DCOLOR_ARGB(255, 255, 51, 204);
    return;
  default:
    szName[0] = '\0';
...
static void __keyframe_proc(DWORD type, DWORD pose_id, DWORD key_id,
                            DWORD key_frame, void *param) {
...
CCharacter::CCharacter()
    : _bEnableAI(FALSE), _isArrive(true), _nTurnCnt(0), _pszFootMusic(NULL),
      _pszWhoopMusic(NULL), _fMaxOpacity(1.0f), _pNpcStateItem(NULL),
      _eChaModalType(enumMODAL_MAIN_CHA), _eChaCtrlType(enumCHACTRL_PLAYER),
      _IsForUI(false), _pDefaultChaInfo(NULL), _bShowSecondName(TRUE),
      _sPhotoID(0), _nNpcType(0), _eMainType(enumMainNone), _nLeaderID(0),
      _chGMLv(0), _pEvent(NULL), _pShipInfo(NULL), _dwHumanID(0),
      _fMapHeight(0.0f), _nGuildID(0), _dwGuildColor(COLOR_BLACK),
      _sReliveTime(60), // 默认为1分钟
      _nPatrolX(0), _nPatrolY(0), _pBoatFog(NULL), _pShopItem(NULL),
      _lSideID(0), _pSideShade(0), _nServerX(0), _nServerY(0), _nDanger(0),
      mParentNode(NULL), mParentBoneID(0) {
...
BOOL CCharacter::_Create(int nCharTypeID, int nType) { return TRUE; }
...
void CCharacter::FrameMove(DWORD dwTimeParam) {
  ...
  if (!_isArrive) {
    if (_IsMoveTimeType) {
      ...
      if (_nTurnCnt > 1)
        _fStepProgressRate =
            _fStepProgressRate +
            _fStep * CWaitMoveState::GetMoveRate() / (float)_nTurnCnt;
      else
        _fStepProgressRate =
            _fStepProgressRate + _fStep * CWaitMoveState::GetMoveRate();
      ...
      // 			if( IsMainCha() )
      // 			{
      //  				IP("Move: Prgrs(%f) Step(%f) Rate(%f) Turn(%d)
      //  Last(%d,%d) Cur(%d,%d) Diff=%d\n", 					_fStepProgressRate, _fStep,
      //  CWaitMoveState::GetMoveRate(), _nTurnCnt, _nLastPosX, _nLastPosY,
      // 					GetCurX(), GetCurY(),
      //  					GetDistance( GetCurX(), GetCurY(),
      //  GetServerX(), GetServerY() )
      //  					);
      // 			}
    ...
    if (_pSceneHeight->FrameMove(dwTimeParam)) {
      ...
      if (_pNpcStateItem) {
        //_pNpcStateItem->setHeightOff( (int)(GetDefaultChaInfo()->fHeight *
        //100.0f) );
        _pNpcStateItem->setHeightOff((int)(GetDefaultChaInfo()->fHeight *
                                           (GetIsFly() ? 130.0f : 100.0f)));
      }
    }
  }
  ...
  if (_Special.IsAny()) {
    ...
    if (_Special.IsTrue(enumHelixIn)) {
      ...
      _nHelixRadii -= 20;
      if (_nHelixRadii > 0) {
        ::eddy(_nHelixCenterX, _nHelixCenterY, _nHelixAngle, _nHelixRadii, x,
               y);
        _nCurX = x;
        _nCurY = y;
      } else {
...
void CCharacter::RefreshUI(int nParam) {
  ...
  if (g_stUIBoat.GetHuman() == this) {
    ...
    g_stUIStart.RefreshMainLifeNum((long)_Attr.get(ATTR_HP),
                                   (long)_Attr.get(ATTR_MXHP));
    g_stUIStart.RefreshMainSP((long)_Attr.get(ATTR_SP),
                              (long)_Attr.get(ATTR_MXSP));

    g_stUIStart.RefreshMainExperience(
        _Attr.get(ATTR_CEXP), _Attr.get(ATTR_CLEXP), _Attr.get(ATTR_NLEXP));
...
int CCharacter::_GetTargetAngle(int nTargetX, int nTargetY, BOOL bBack) {
  D3DXVECTOR2 dPosition = D3DXVECTOR2((float)nTargetX, (float)nTargetY) -
                          D3DXVECTOR2((float)_nCurX, (float)_nCurY);
  if (bBack)
    dPosition *= -1;
...
void CCharacter::setPos(int nX, int nY) {
  ...
  if (IsMainCha()) {
    ...
    if (dis > 300.0f)
      LG("main_cha_pos",
         "\t\tpos:%d, %d, target:%d, %d, dis:%d, Tick:%d, FPS: %d\n", _nCurX,
         _nCurY, nX, nY, dis, GetTickCount() - tick, g_Render.GetFPS());
    else
      LG("main_cha_pos",
         "pos:%d, %d, target:%d, %d, dis:%d, Tick:%d, FPS: %d\n", _nCurX,
         _nCurY, nX, nY, dis, GetTickCount() - tick, g_Render.GetFPS());
...
CEffectObj *CCharacter::SelfEffect(int nEffectID, int nDummy, bool isLoop,
                                   int nSize, int nAngle) {
  if (nEffectID <= 0)
    return NULL;

  // added by Philip.Wu  2008-01-25 乱斗白银城里不播放这些特效
  if (g_stUIMap.IsPKSilver() && this->IsPlayer() &&
      this->GetMainType() != enumMainPlayer) {
...
CEffectObj *CCharacter::SkyEffect(int nEffectID, int nBeginDummy,
                                  int nItemDummy, int nSpeed,
                                  D3DXVECTOR3 *pTarget, int nTargetChaID,
                                  CSkillRecord *pSkill) {
  if (nEffectID <= 0)
    return NULL;
  ...
  if (pSkill) {
    ...
    case enumRANGE_TYPE_STICK: // 柱形（长度，宽度）
    {
      ...
      int x, y;
      GetDistancePos(GetCurX(), GetCurY(), int(pTarget->x * 100.0f),
                     int(pTarget->y * 100.0f), 500, x, y);
...
//		{
//		case 1:
//			//_fMapHeight = (float)_pDefaultChaInfo->sSeaHeight /
//100.0f; 			_fMapHeight = fhei +_pScene->GetGridHeight(_vPos.x, _vPos.y); 			break;
//		default:
//			_fMapHeight = _pScene->GetGridHeight(_vPos.x, _vPos.y);
//		}
//
...
void CCharacter::ActionKeyFrame(DWORD key_id) {
  if (_pDefaultChaInfo) {
    if (_pDefaultChaInfo->sEffectActionID[0] == key_id) {
      SelfEffect(_pDefaultChaInfo->sEffectActionID[1],
                 _pDefaultChaInfo->sEffectActionID[2]);
    }
  }
  ...
  if (_IsShowShadow && _eChaCtrlType == enumCHACTRL_PLAYER && !IsBoat() &&
      GetScene()->GetTileTexAttr((int)GetPos().x, (int)GetPos().y) == 1) {
    GetScene()->GetPugMgr()->NewPug(&GetPos(),
                                    (float)getYaw() * 0.01745329f + D3DX_PI);
  }
}
...
bool CCharacter::PlayPose(DWORD pose, DWORD type, int time, int fps,
                          bool isBlend) {
  ...
  if (GetIsFly()) {
    if (pose == POSE_WAITING || pose == POSE_WAITING2)
      pose = POSE_FLY_WAITING; // 站立 -> 飞行
    if (pose == POSE_RUN || pose == POSE_RUN2)
      pose = POSE_FLY_RUN; // 走动 -> 飘走
    if (pose == POSE_SHOW)
      pose = POSE_FLY_SHOW; // 摆酷 -> 空中摆酷
    if (pose == POSE_SEAT)
      pose = POSE_FLY_SEAT; // 坐下 -> 空中悬空坐
  }
#endif

  if ((GetCurPoseType() == POSE_RUN2) || (GetCurPoseType() == POSE_RUN) ||
      GetCurPoseType() == POSE_FLY_RUN) {
  ...
  if (isBlend) {
    ...
    if (enumMODAL_MAIN_CHA == _eChaModalType && pose > POSE_WAITING &&
        pose < POSE_ATTACK) {
      CCharacterModel::PlayPose(pose, type, time, fps, 1);
    } else {
  ...
  if (isFight) {
    ...
    if (_pHandItem[enumEQUIP_LHAND]) {
      ...
      dummy = GetWeaponBackDummy(
          _pHandItem[enumEQUIP_LHAND]->GetItemInfo()->sType, true);
      if (dummy > 0) {
    ...
    if (_pHandItem[enumEQUIP_RHAND]) {
      ...
      dummy = GetWeaponBackDummy(
          _pHandItem[enumEQUIP_RHAND]->GetItemInfo()->sType, false);
      if (dummy > 0) {
...
void CCharacter::UpdataFace(stNetChangeChaPart &stPart) {
  ...
  /*if( IsPlayer() && !IsBoat() )
  {
          if ( itemID == 6947 )
          {
                  SetPreNameByEnergy( itemID, itemEnergy, _szPreName,
  _szPreColor, sizeof(_szPreName) );
          }
          else
          {
  ...
  // rain add begin
  if (!IsBoat() && (nCharID == 1 || nCharID == 2) &&
      (itemID == 6707 || itemID == 6708)) {
    SetPreNameSex(itemID, _szPreName, _szPreColor, sizeof(_szPreName));
    //		SetPreNameByEnergy( itemID, itemEnergy, _szPreName, _szPreColor,
    //sizeof(_szPreName), 1 );
  } else if (!IsBoat() && (nCharID == 3 || nCharID == 4) &&
             (itemID == 6707 || itemID == 6708)) {
    SetPreNameSex(itemID + 10, _szPreName, _szPreColor, sizeof(_szPreName));
    //		SetPreNameByEnergy( itemID+10, itemEnergy, _szPreName, _szPreColor,
    //sizeof(_szPreName), 1 );
  }
  //	end
  memcpy(&_stChaPart, &stPart, sizeof(_stChaPart));
  ...
  _DetachAllItem();
  int nHairID = stPart.SLink[enumEQUIP_HEAD].sID != 0
                    ? stPart.SLink[enumEQUIP_HEAD].sID
                    : stPart.sHairID;
  ...
  if (nCharID >= 1 || nCharID <= 4) {
    if (_pHandItem[enumEQUIP_RHAND])
      _pHandItem[enumEQUIP_RHAND]->SetForgeEffect(
          stPart.SLink[enumEQUIP_RHAND].lDBParam[0], nCharID);

    if (_pHandItem[enumEQUIP_LHAND])
      _pHandItem[enumEQUIP_LHAND]->SetForgeEffect(
          stPart.SLink[enumEQUIP_LHAND].lDBParam[0], nCharID);
  }
  //
  //    // 拳套特殊处理，左手自动装入另一只拳套
  //    if( _pHandItem[enumEQUIP_RHAND] &&
  //    _pHandItem[enumEQUIP_RHAND]->GetItemInfo()->sType==6 )
  //    {
  ...
  // if( _pHandItem[enumEQUIP_LHAND] &&
  // _pHandItem[enumEQUIP_LHAND]->GetItemInfo()->sType==29 )
  //{
  // 冲击贝直接装在手上
  //_FightSwitch( true );
  //}
  ...
  //
  //// 道具精炼
  // if( stPart.SLink[enumEQUIP_RHAND].sID>0 &&
  // (stPart.SLink[enumEQUIP_RHAND].chForgeLv)>=0 )
  //{
  //}
  // else
  //{
  ...
  // if( stPart.SLink[enumEQUIP_LHAND].sID>0 &&
  // (stPart.SLink[enumEQUIP_LHAND].chForgeLv)>=0 )
  //{
  //}
  // else
  //{
...
xShipInfo *CCharacter::ConvertPartTo8DWORD(stNetChangeChaPart &stPart,
                                           DWORD *dwBuf) {
...
bool CCharacter::UpdataItem(int nItem, DWORD nLink) {
  ...
  case 4:
    ...
    if (CCharacterModel::ChangePart(nLink, nItem) == 0) {
      // 			LG( getLogName(), "msgChangePart Error, Item[%d],
      // Link[%d]\n\n", nItem, nLink );
      return false;
    }
    return true;
  ...
  case enumEQUIP_RHAND:
    if (nItem > 0 && nItem != enumEQUIP_BOTH_HAND) {
      if (!_pHandItem[nLink] ||
          _pHandItem[nLink]->GetItemInfo()->lID != nItem) {
        if (_pHandItem[nLink]) {
        ...
        if (item) {
          ...
          // 					LG( getLogName(), "msgChangePart AddSceneItem Error,
          // Item[%d], Link[%d]\n\n", nItem, nLink );
          return false;
        }
      }
...
void CCharacter::SynchroSkillState(stSkillState *pState, int nCount) {
  ...
  if (set.IsTrue(enumChaStateNoAni) != _ChaState.IsTrue(enumChaStateNoAni)) {
    if (set.IsTrue(enumChaStateNoAni)) {
      ...
      PlayAni(CChaStateMgr::GetLastActInfo()->nActBehave,
              CChaStateMgr::GetLastActInfo()->GetActNum());
    }
  }
  ...
  if (set.IsTrue(enumChaStateNoDizzy) !=
      _ChaState.IsTrue(enumChaStateNoDizzy)) {
    if (_pDefaultChaInfo->IsCyclone()) {
      if (set.IsTrue(enumChaStateNoDizzy)) {
        CCharacterModel::SetDrunkState(FALSE);

        // CDizzyState* pState =
        // dynamic_cast<CDizzyState*>(GetActor()->GetCurState()); if( pState )
        // pState->Stop();
      } else {
...
bool CCharacter::GetRunTimeMatrix(LEMatrix44 *mat, DWORD dummy_id) {
  return GetObjDummyRunTimeMatrix(mat, dummy_id) == 0;
}

void CCharacter::LoadingCall() { RefreshItem(true); }
  ...
  if (_IsMoveTimeType) {
    ...
    if (g_Render.IsRealFPS()) {
      ...
      if (CGameApp::GetFrameFPS() == 30)
        _fStep = 1.0f / (fDistance / (float)getMoveSpeed() *
                         (float)(CGameApp::GetFrameFPS() + 2));
      else
        _fStep = 1.0f / (fDistance / (float)getMoveSpeed() *
                         (float)(CGameApp::GetFrameFPS() + 2));
    }
    //  	IP("_nCur(%d,%d) ->(%d,%d), Dxy(%d,%d) fDistance=%f
    //  _fStep=%f\n", 		_nCurX, _nCurY, nTargetX, nTargetY, nTargetX-_nCurX,
    //  nTargetY-_nCurY,fDistance,_fStep);
...
void CCharacter::RefreshFog() {
  ...
  int nEffectID = 0;
  float fHPRate =
      (float)getGameAttr()->get(ATTR_HP) / (float)getGameAttr()->get(ATTR_MXHP);
  if (fHPRate < hp[0]) {
...
void CCharacter::SetItemFace(unsigned int nIndex, int nItem) {
  ...
  case 0: // 第一栏放置翅膀
    if (pInfo->sType != enumItemTypeWing) {
      ...
      if (g_stUIMap.IsPKSilver() && pCha->IsPlayer() &&
          pCha->GetMainType() != enumMainPlayer)
        return;
      ...
      if (pInfo->chBody[0] != -1) {
        ...
        for (int i = 0; i < defITEM_BODY; i++) {
          if (pInfo->chBody[i] != -1 &&
              pInfo->chBody[i] == GetDefaultChaInfo()->lID) {
            bFlag = true;
            break;
          }
        }
...
bool CCharacter::GetIsFly() {
  ...
  // return (pItem && pItem->sType == 44 && _Attr.get(ATTR_SAILLV) > 0) ? true :
  // false;
}
...
bool CCharacter::IsReadingBook() {
  CReadingState *pState =
      dynamic_cast<CReadingState *>(GetActor()->GetCurState());
  return (0 != pState);
}
