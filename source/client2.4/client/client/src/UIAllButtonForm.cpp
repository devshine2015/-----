...
bool AllButtonMgr::Init() {
  ...
  FORM_CONTROL_LOADING_CHECK(cboCion1, frmElfCoin, CCombo, "dialog.clu",
                             "cboCion1");
  cboCion1 = dynamic_cast<CCombo *>(frmElfCoin->Find("cboCion1"));
  cboCion1->evtSelectChange = evtCloseCompany;

  FORM_CONTROL_LOADING_CHECK(cboCion2, frmElfCoin, CCombo, "dialog.clu",
                             "cboCion2");
  cboCion2 = dynamic_cast<CCombo *>(frmElfCoin->Find("cboCion2"));
  cboCion2->evtSelectChange = evtCloseCompany;

  FORM_CONTROL_LOADING_CHECK(cboCion3, frmElfCoin, CCombo, "dialog.clu",
                             "cboCion3");
...
void AllButtonMgr::_evtAllButtonMouseEvent(CCompent *pSender, int nMsgType,
