...
// Scene_Script
//---------------------------------------------------------------------------
int SN_CreateScene(int type, char *name, char *map_name, int ui, int max_cha,
                   int max_obj, int max_item, int max_eff) {
...
void MPInitLua_Scene() {
  CLU_RegisterFunction("SN_CreateScene", "int",
                       "int,char*,char*,int,int,int,int,int", CLU_CDECL,
                       CLU_CAST(SN_CreateScene));
  CLU_RegisterFunction("SN_SetTerrainShowCenter", "int", "int,int,int",
                       CLU_CDECL, CLU_CAST(SN_SetTerrainShowCenter));
  CLU_RegisterFunction("SN_SetIsShow3DCursor", "int", "int", CLU_CDECL,
                       CLU_CAST(SN_SetIsShow3DCursor));
  CLU_RegisterFunction("SN_SetIsShowMinimap", "int", "int", CLU_CDECL,
                       CLU_CAST(SN_SetIsShowMinimap));
  CLU_RegisterFunction("SN_SetAttackChaColor", "int", "int,int,int", CLU_CDECL,
                       CLU_CAST(SN_SetAttackChaColor));

  CLU_RegisterFunction("CHA_SetClientAttr", "int", "int,int,float,float",
                       CLU_CDECL, CLU_CAST(CHA_SetClientAttr));
  CLU_RegisterFunction("CameraRangeXY", "int", "int,float,float", CLU_CDECL,
                       CLU_CAST(CameraRangeXY));
  CLU_RegisterFunction("CameraRangeZ", "int", "int,float,float", CLU_CDECL,
                       CLU_CAST(CameraRangeZ));
  CLU_RegisterFunction("CameraRangeFOV", "int", "int,float,float", CLU_CDECL,
                       CLU_CAST(CameraRangeFOV));
  CLU_RegisterFunction("CameraEnableRotate", "int", "int,int", CLU_CDECL,
                       CLU_CAST(CameraEnableRotate));
  CLU_RegisterFunction("CameraShowSize", "int", "int,int,int", CLU_CDECL,
                       CLU_CAST(CameraShowSize));
}
...
void MPInitLua_Scene1024() {
  ...
  CLU_RegisterFunction("CameraEnableRotate", "int", "int,int", CLU_CDECL,
                       CLU_CAST(CameraEnableRotate));
  CLU_RegisterFunction("CameraShowSize1024", "int", "int,int,int", CLU_CDECL,
                       CLU_CAST(CameraShowSize1024));
}
