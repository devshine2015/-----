...
public:
	...
	BOOL    Init(LPDIRECT3DDEVICE8	pDev)
	{
		...
		mi.vertex_seq[0] = LEVector3(-frad, -frad,  0.000001f);
		mi.vertex_seq[1] = LEVector3(frad, -frad,   0.000001f);
		mi.vertex_seq[2] = LEVector3(frad, frad,    0.000001f);
		mi.vertex_seq[3] = LEVector3(-frad, frad,   0.000001f);
		...
		char* pszName[] = 
		{
			...
			"texture\\minimap\\1.tga",
				...
				"texture\\minimap\\14.tga",
				"texture\\minimap\\15.tga",
		...
		{
#ifdef MGR
			if(FAILED(drLoadTex(&_pTex[n],res_mgr, pszName[n], 0, D3DFMT_A4R4G4B4)))
			{
