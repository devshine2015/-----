...
extern void NetPC_GUILD_START(bool online,uLong chaid,cChar *chaname,cChar *motto,cChar *job,uShort degree,uShort icon,uShort permission);
extern void NetPC_GUILD_STOP();

extern void NetPC_GUILD_ADD(bool online,uLong chaid,cChar *chaname,cChar *motto,cChar *job,uShort degree,uShort icon,uShort permission);
...
extern void NetGuildInvite(const char *inviter_name, unsigned long inviter_chaid,unsigned short icon);
extern void NetGuildCancel(unsigned long  inviter_chaid,char reason);

extern BOOL	PC_GUILD_INVITE(LPRPACKET pk);
extern BOOL	PC_GUILD_CANCEL(LPRPACKET pk);