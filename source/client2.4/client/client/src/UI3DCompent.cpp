...
C3DCompent::C3DCompent(CForm &frmOwn)
    : CCompent(frmOwn), _pRenderEvent(NULL), evtMouseDown(NULL),
      evtMouseLDDown(NULL), _pPointer(NULL) {}

C3DCompent::C3DCompent(const C3DCompent &rhs) : CCompent(rhs) { _Copy(rhs); }
