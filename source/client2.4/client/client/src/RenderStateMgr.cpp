...
HRESULT RenderStateMgr::Init(LEIDeviceObject *dev_obj) {
  _dev_obj = dev_obj;
  ...
  // begin scene
  {
    LEGUIDCreateObject((DR_VOID **)&_rsa_scene, DR_GUID_RENDERSTATEATOMSET);
  ...
  { // begin rsa_scnobj
    ...
    LEGUIDCreateObject((DR_VOID **)&_rsa_sceneobj, DR_GUID_RENDERSTATEATOMSET);
    ...
    if (dev_caps->RasterCaps & D3DPRASTERCAPS_ANISOTROPY) {
      _rsa_sceneobj->SetStateValue(tss_id++, D3DTSS_MINFILTER,
                                   D3DTEXF_ANISOTROPIC);
      _rsa_sceneobj->SetStateValue(tss_id++, D3DTSS_MAGFILTER,
                                   D3DTEXF_ANISOTROPIC);
      _rsa_sceneobj->SetStateValue(tss_id++, D3DTSS_MIPFILTER,
                                   D3DTEXF_ANISOTROPIC);
      _rsa_sceneobj->SetStateValue(tss_id++, D3DTSS_MAXANISOTROPY,
                                   dev_caps->MaxAnisotropy);
    } else {
    ...
    D3DXVec3Normalize((D3DXVECTOR3 *)&_scnobj_lgt.Direction,
                      (D3DXVECTOR3 *)&_scnobj_lgt.Direction);
  ...
  // begin _rsa_cha
  {
    LEGUIDCreateObject((DR_VOID **)&_rsa_cha, DR_GUID_RENDERSTATEATOMSET);
    ...
    if (dev_caps->RasterCaps & D3DPRASTERCAPS_ANISOTROPY) {
      ...
      _rsa_cha->SetStateValue(tss_id++, D3DTSS_MAXANISOTROPY,
                              dev_caps->MaxAnisotropy);
    } else {
    ...
    D3DXVec3Normalize((D3DXVECTOR3 *)&_cha_lgt.Direction,
                      (D3DXVECTOR3 *)&_cha_lgt.Direction);
  ...
  {
    LEGUIDCreateObject((DR_VOID **)&_rsa_transpobj, DR_GUID_RENDERSTATEATOMSET);
    ...
    _rsa_transpobj->SetStateValue(rs_id++, D3DRS_DESTBLEND,
    ...
    D3DCAPSX *dev_caps = dev_obj->GetDeviceCaps();
    if (dev_caps->RasterCaps & D3DPRASTERCAPS_ANISOTROPY) {
      _rsa_transpobj->SetStateValue(tss_id++, D3DTSS_MINFILTER,
                                    D3DTEXF_ANISOTROPIC);
      _rsa_transpobj->SetStateValue(tss_id++, D3DTSS_MAGFILTER,
                                    D3DTEXF_ANISOTROPIC);
      _rsa_transpobj->SetStateValue(tss_id++, D3DTSS_MIPFILTER,
                                    D3DTEXF_ANISOTROPIC);
      _rsa_transpobj->SetStateValue(tss_id++, D3DTSS_MAXANISOTROPY,
                                    dev_caps->MaxAnisotropy);
    } else {
...
HRESULT RenderStateMgr::BeginSceneItem() { return 0L; }
HRESULT RenderStateMgr::BeginTerrain() { return 0L; }
...
HRESULT RenderStateMgr::EndSceneItem() { return 0L; }
HRESULT RenderStateMgr::EndTerrain() { return 0L; }
