...
EShowWhat _GetShowWhat() {
  ...
  /* 这段代码会引起窗口无响应 by Waiting 2009-06-24
          ...
          nClipTypeWhileBackground = ::GetClipBox( hdc,
     &rcClipBoxWhileBackground ); ReleaseDC(hwnd, hdc); if(
     nClipTypeWhileBackground==NULLREGION || nClipTypeWhileBackground==ERROR )
...
void CSteadyFrame::End() { _dwTotalTime += GetTickCount() - _dwCurTime; }
