...
class CGameApp : public LEGameApp
{
public:
	CGameApp();
	~CGameApp();
...
#ifdef _SKYBOX_
	CMPSkyBox*			GetSkyBox()						{ return _pSkyBox;		} 
#endif
...
public:    
	...
	void			PlaySample( string SoundName, double Volume = 0, int Pan = 0 );		// modify by rock.wang 090624
...
protected:
	...
	BOOL				_CreateSmMap( LETerrain* pTerr );
    void                _RenderTipText();
    void                _ShowLoading();
...
private:		// 用于脚本
	...
	CLEFont				g_CFont;
	CLEFont             _MidFont;         // 在屏幕中央偏上的一个中等字体
    STipText            _stMidFont;
