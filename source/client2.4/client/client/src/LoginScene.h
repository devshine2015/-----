...
class CLoginScene : public CGameScene, public CFlashPlayer
{
public:	
	...
	// Xuqin added for flash control.
	BOOL	FlashProc( UINT message, WPARAM wParam, LPARAM lParam );
	VOID	FSCommand( char* szParam1, char* szParam2 );
	void InitRegionList();
...
private:
	...
	static CImage*          imgLogo1;		// add by Philip.Wu  那个啥LOGO图1     2006-06-20
	static CImage*          imgLogo2;		// add by Philip.Wu  那个啥LOGO图2     2006-06-20
