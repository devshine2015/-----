...
int AnimCtrlLight::UpdateObject(SceneLight* ret_obj)
{
    ...
    ret_obj->type = u->type;
    LEVector3Slerp((LEVector3*)&ret_obj->pos, (LEVector3*)&u->pos, (LEVector3*)&v->pos, t);
    LEVector3Slerp((LEVector3*)&ret_obj->amb.r, (LEVector3*)&u->amb.r, (LEVector3*)&v->amb.r, t);
    LEVector3Slerp((LEVector3*)&ret_obj->dif.r, (LEVector3*)&u->dif.r, (LEVector3*)&v->dif.r, t);
