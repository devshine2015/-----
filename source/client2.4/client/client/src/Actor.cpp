...
//---------------------------------------------------------------------------
CMonsterItem::CMonsterItem() : _pCha(NULL), _pItem(NULL) {}
...
//---------------------------------------------------------------------------
CMissionTrigger::CMissionTrigger() { _pData = new stNetNpcMission; }
...
void CMissionTrigger::Exec() {
  ...
  g_pGameApp->ShowMidText(RES_STRING(CL_LANGUAGE_MATCH_3), szData,
                          _pData->sCount, _pData->sNum);
}
