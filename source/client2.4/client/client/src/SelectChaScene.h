...
private:
    ...
    ChaFontPtrContainer m_CharactorPtrs;        //场景中的角色(包括字体)
    vector<int>         m_XPositions;           //场景中三个人物的位置X坐标
    vector<int>         m_YPositions;           //场景中三个人物的位置Y坐标
    vector<int>         m_Yaws;                 //场景中人物的旋转
    vector<int>         m_FreePositions;        //场景中空位置的索引
