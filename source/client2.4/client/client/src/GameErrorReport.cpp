...
string GetTimeStamp() {
  ...
  _snprintf_s(buf, _countof(buf), _TRUNCATE,
              "%04d-%02d-%02d %02d.%02d.%02d.%03d", l_st.wYear, l_st.wMonth,
              l_st.wDay, l_st.wHour, l_st.wMinute, l_st.wSecond,
              l_st.wMilliseconds);
  return buf;
}
  ...
  try {
    ...
    if (CheckDxVersion(dx_ver)) {
      ...
      if (g_Render.GetDevice()) {
        ...
        // caps.CubeTextureFilterCaps); fprintf(fp, "VolumeTextureFilterCaps
        // %X\r\n", caps.VolumeTextureFilterCaps); fprintf(fp,
        // "TextureAddressCaps %X\r\n", caps.TextureAddressCaps); fprintf(fp,
        ...
        // caps.MaxTextureAspectRatio); fprintf(fp, "MaxAnisotropy %X\r\n",
        // caps.MaxAnisotropy); fprintf(fp, "MaxVertexW %f\r\n",
        // caps.MaxVertexW); fprintf(fp, "GuardBandLeft %f\r\n",
        // caps.GuardBandLeft); fprintf(fp, "GuardBandTop %f\r\n",
        // caps.GuardBandTop); fprintf(fp, "GuardBandRight %f\r\n",
        // caps.GuardBandRight); fprintf(fp, "GuardBandBottom %f\r\n",
        // caps.GuardBandBottom); fprintf(fp, "ExtentsAdjust %f\r\n",
        // caps.ExtentsAdjust); fprintf(fp, "StencilCaps %X\r\n",
        // caps.StencilCaps); fprintf(fp, "FVFCaps %X\r\n", caps.FVFCaps);
        // fprintf(fp, "TextureOpCaps %X\r\n", caps.TextureOpCaps);
        // fprintf(fp, "MaxTextureBlendStages %X\r\n",
        // caps.MaxTextureBlendStages); fprintf(fp, "MaxSimultaneousTextures
        // %X\r\n", caps.MaxSimultaneousTextures); fprintf(fp,
        // "VertexProcessingCaps %X\r\n", caps.VertexProcessingCaps); fprintf(fp,
        // "MaxActiveLights %X\r\n", caps.MaxActiveLights); fprintf(fp,
        // "MaxUserClipPlanes %X\r\n", caps.MaxUserClipPlanes); fprintf(fp,
        // "MaxVertexBlendMatrices %X\r\n", caps.MaxVertexBlendMatrices);
        // fprintf(fp, "MaxVertexBlendMatrixIndex %X\r\n",
        // caps.MaxVertexBlendMatrixIndex); fprintf(fp, "MaxPointSize %f\r\n",
        // caps.MaxPointSize); fprintf(fp, "MaxPrimitiveCount %X\r\n",
        // caps.MaxPrimitiveCount); fprintf(fp, "MaxVertexIndex %X\r\n",
        // caps.MaxVertexIndex); fprintf(fp, "MaxStreams %X\r\n",
        // caps.MaxStreams); fprintf(fp, "MaxStreamStride %X\r\n",
