...
public:
	...
	static void		AddMsg(eChannel channel, string strWho, string strText, bool bSendTo = false);
...
public:
	...
	void OnSightMsg(string strName, string strMsg);
	void OnSightMsg(CCharacter* pChar, string strMsg);
	void OnPrivateMsg(string strFromName, string strToName, string strMsg);
	void OnWorldMsg(string strName, string strMsg);
	void OnTradeMsg(string strName, string strMsg);
	void OnTeamMsg(string strName, string strMsg);
...
protected:
	...
	static void EventPublishSendMsg1(CGuiData *pSender);//Add by sunny.sun20080804	
