...
#endif
// 多语言库须先初始化
// CLanguageRecord g_oLangRec("./scripts/table/StringSet.bin",
// "./scripts/table/StringSet.txt"); pi_LeakReporter
// pi_leakReporter("gamememleak.log"); CResourceBundleManage
// g_ResourceBundleManage("Game.loc"); //Add by lark.li 20080130
