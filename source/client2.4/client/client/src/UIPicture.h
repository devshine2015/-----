...
public:	// 以下坐标为屏幕上的坐标
	...
	static bool LoadImage( LETexRect* pTex, const char* file, int w, int h, int tx=0, int ty=0, float scale_x=1.0, float scale_y=1.0 );
...
public:
	...
	LETexRect*		GetImage( unsigned int v=0 ) { 
